...
function shoppingTime(memberId, money) {
  ...
  member[0].money = money;
  member[0].listPurchased = [];
  if (money >= stacattu) {
      money -= stacattu;
      member[0].listPurchased[member[0].listPurchased.length] = "stacattu";
  }; 
  if (money >= zoro) {
      money -= zoro;
      member[0].listPurchased[member[0].listPurchased.length] = "zoro";
  };
  if (money >= hnN) {
    money -= hnN;
    member[0].listPurchased[member[0].listPurchased.length] = "hnN";
  };  
  if (money >= uniklooh) {
    money -= uniklooh;
    member[0].listPurchased[member[0].listPurchased.length] = "uniklooh";
  };
  if (money >= casing) {
    money -= casing;
    member[0].listPurchased[member[0].listPurchased.length] = "casing";
    member[0].changeMoney = money;
    return member;
  } else {
